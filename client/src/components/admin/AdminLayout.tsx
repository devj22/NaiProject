            ...
            <div className="bg-white rounded-lg shadow-sm p-4 sticky top-24">
              <nav className="space-y-1">
                <Link
                  ...
                  className={`flex items-center px-4 py-3 rounded-md ${isActive("/admin/dashboard") ? "bg-primary text-white" : "text-gray-700 hover:bg-gray-100"}`}
                >
                ...
                <Link
                  ...
                  className={`flex items-center px-4 py-3 rounded-md ${isActive("/admin/properties") ? "bg-primary text-white" : "text-gray-700 hover:bg-gray-100"}`}
                >
                ...
                <Link
                  href="/admin/blogs"
                  className={`flex items-center px-4 py-3 rounded-md ${isActive("/admin/blogs") ? "bg-primary text-white" : "text-gray-700 hover:bg-gray-100"}`}
                >
                ...
                <Link
                  href="/admin/messages"
                  className={`flex items-center px-4 py-3 rounded-md ${isActive("/admin/messages") ? "bg-primary text-white" : "text-gray-700 hover:bg-gray-100"}`}
                >
              ...
              <div className="pt-6 mt-6 border-t border-gray-200">
                ...
                <nav className="space-y-1">
                  <Link
                    href="/admin/properties"
                    className="flex items-center px-4 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded"
                  >
